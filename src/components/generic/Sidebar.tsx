...
export default function Sidebar() {
  ...
  const { user } = useUser();
  return (
    <div className="flex w-60 border-r border-r-neutral-200 items-start py-8 flex-col justify-between">
      <div className="flex flex-col gap-2 w-full">
        {sidebarRoutesArray.map((route) => {
          return (
            <Link
              className={`flex gap-2 items-center font-medium pl-6 py-2 hover:bg-neutral-200 w-full ${
